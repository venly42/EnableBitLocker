...
rem
rem Copyright 2023 Dell Inc. or its subsidiaries.  All Rights Reserved.
rem
...
:: ***************************************************************************
REM Name: cctk_x86_64_winpe_11.bat
REM
REM Purpose:
REM    This script installs Dell drivers into a base Windows PE 11.0 image offline.
REM  
REM Arguments:
REM    %1 Path to local directory for customized Windows PE 11.0 image to create
REM    %2 Path to extracted Command Configure toolkit
REM	Example: cctk_x86_64_WinPE_11.bat C:\Winape_x64 C:\Progra~2\Dell\Comman~1\
...
"%IMAGEX%" /BOOT /COMPRESS maximum /CAPTURE %WINPEPATH%\mount\ %WINPEPATH%\WIM\boot.wim "Command Configure WinPE 11 Image"

@echo ---------------------------------------------
@echo - 8 Commit the customization to base image 
@echo ---------------------------------------------
REM move %WINPEPATH%\ISO\sources\boot.wim %WINPEPATH%\boot-base.wim
REM copy %WINPEPATH%\wim\boot.wim    %WINPEPATH%\wim\cctk_x86_pe11.wim
...
"%OSCDImgRoot%\oscdimg.exe" -b%WINPEPATH%\fwfiles\etfsboot.com -n %WINPEPATH%\ISO %WINPEPATH%\WIM\Command_Configure_x86_64_11.iso
...
:usage
echo.
echo cctk_x86_64_winpe_11.bat
echo.
echo Copyright 2023 Dell Inc. All rights reserved.
echo.
echo Usage : cctk_x86_64_winpe_11.bat WINPEPATH CCTKPATH
echo.
echo Where:
echo   WINPEPATH   path where the Windows PE 11.0 contents should create
...
echo ***********************************************************************
echo.
echo Example: cctk_x86_64_WinPE_11.bat C:\winsevpe_x64 C:\Progra~2\Dell\Comman~1\
echo.
echo.
...
:done
@echo -------------------------------
@echo (cctk_x6_winpe_11.bat)-DONE
@echo -------------------------------
set WINPEPATH=
set CCTKPATH=
set AIKTOOLS=
